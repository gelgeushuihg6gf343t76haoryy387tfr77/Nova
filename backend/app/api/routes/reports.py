...
from app.api.deps import get_current_business_id, require_pro_plan
...
@router.get("/monthly", response_model=ReportsResponse, dependencies=[Depends(require_pro_plan)])
...
@router.get("/export", dependencies=[Depends(require_pro_plan)])
